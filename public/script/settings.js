...
saveButton.addEventListener("click", async () => {
  ...
  document.getElementById('settingsfilled').classList.add('hidden');
  document.getElementById('settingssvg').classList.remove('hidden');
  document.getElementById('homefilled').classList.remove('hidden');
  document.getElementById('homesvg').classList.add('hidden');
